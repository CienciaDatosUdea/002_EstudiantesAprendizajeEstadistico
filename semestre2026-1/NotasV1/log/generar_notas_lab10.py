"""
generar_notas_lab10.py
----------------------
Lab 10: Red neuronal con Keras — 2 puntos

Fuente : EstudiantesOrdenado/  (estructura canónica Lab10/)
Salida : NotasV1/lab10_matriz.csv  (se sobreescribe en cada ejecución)
"""
...
OUTPUT_CSV      = ROOT / "NotasV1" / "lab10_matriz.csv"
