"""
generar_notas_lab11.py
----------------------
Lab 11: Árbol de decisión — 7 puntos

Fuente : EstudiantesOrdenado/  (estructura canónica Lab11/)
Salida : NotasV1/lab11_matriz.csv  (se sobreescribe en cada ejecución)
"""
...
OUTPUT_CSV      = ROOT / "NotasV1" / "lab11_matriz.csv"
