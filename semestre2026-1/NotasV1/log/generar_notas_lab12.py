"""
generar_notas_lab12.py
----------------------
Lab 12: Random Forest — 3 puntos

Fuente : EstudiantesOrdenado/  (estructura canónica Lab12/)
Salida : NotasV1/lab12_matriz.csv  (se sobreescribe en cada ejecución)
"""
...
OUTPUT_CSV      = ROOT / "NotasV1" / "lab12_matriz.csv"
