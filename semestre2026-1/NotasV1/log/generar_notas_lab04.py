"""
generar_notas_lab04.py
----------------------
Lab 04: Regresión lineal y gradiente descendente — 12 puntos

Fuente : EstudiantesOrdenado/  (estructura canónica Lab04/)
Salida : NotasV1/lab04_matriz.csv  (se sobreescribe en cada ejecución)
"""
...
OUTPUT_CSV      = NOTAS_V1_DIR / "lab04_matriz.csv"
...
# ---------------------------------------------------------------------------
# Búsqueda de notebooks: Lab04/ en cualquier nivel
# ---------------------------------------------------------------------------
def collect_lab04_notebooks(student_dir: Path) -> list[Path]:
    return sorted(
        path
        for path in student_dir.rglob("*.ipynb")
        if ".ipynb_checkpoints" not in path.parts
        and "Lab04" in path.parts
    )
...
def build_matrix() -> list[dict]:
    ...
    for student_dir in student_dirs:
        notebooks = collect_lab04_notebooks(student_dir)
