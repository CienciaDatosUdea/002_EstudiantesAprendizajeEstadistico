"""
generar_notas_lab07.py
----------------------
Lab 07: ABC del Modelo — 17 puntos

Fuente : EstudiantesOrdenado/  (estructura canónica Lab07/)
Salida : NotasV1/lab07_matriz.csv  (se sobreescribe en cada ejecución)
"""
...
OUTPUT_CSV      = ROOT / "NotasV1" / "lab07_matriz.csv"
